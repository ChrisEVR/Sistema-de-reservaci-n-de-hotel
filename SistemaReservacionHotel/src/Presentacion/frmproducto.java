...
public class frmproducto extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cbounidad_medida = new javax.swing.JComboBox<String>();
        ...
        jLabel25.setText("Unidad medida:");
        ...
        panelImage2Layout.setHorizontalGroup(
            ...
            .addGroup(panelImage2Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(txtidproducto, javax.swing.GroupLayout.DEFAULT_SIZE, 77, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        cbounidad_medida.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        cbounidad_medida.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "KG", "UND", "LT", "MIN", "GLB" }));
        cbounidad_medida.setBorder(null);
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
        ...
        if(txtnombre.getText().length()==0){
            JOptionPane.showMessageDialog(null, "Debes ingresar un nombre de producto","Error",JOptionPane.ERROR_MESSAGE);
            txtnombre.requestFocus();
            return;
        }
        if(txtdescripcion.getText().length()==0){
            JOptionPane.showMessageDialog(null, "Debes ingresar una descripción para el producto","Error",JOptionPane.ERROR_MESSAGE);
            txtdescripcion.requestFocus();
            return;
        }
        if(txtprecio_venta.getText().length()==0){
            JOptionPane.showMessageDialog(null, "Debes ingresar un precio de venta","Error",JOptionPane.ERROR_MESSAGE);
        ...
        if(accion.equals("guardar")){
            if(func.insertar(dts)){
                JOptionPane.showMessageDialog(null, "El producto fue registrado satisfactoriamente","Producto registrado",JOptionPane.INFORMATION_MESSAGE);
                mostrar("");
                inhabilitar();
            }
            ...
            if(func.editar(dts)){
                JOptionPane.showMessageDialog(panelImage2, "El producto fue modificado satisfactoriamente","Producto modificado",JOptionPane.INFORMATION_MESSAGE);
                mostrar("");
                inhabilitar();
            }
        }
    ...
    private void btneliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneliminarActionPerformed
        ...
        if (!txtidproducto.getText().equals("")) {
            int confirmacion = JOptionPane.showConfirmDialog(panelImage2, "Estas seguro de eliminar este producto?","Advertencia",2,JOptionPane.WARNING_MESSAGE);
